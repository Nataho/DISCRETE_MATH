...
class Conversion:
    ...
    def __init__(self):
        clear_screen()
        print("🛠️ Base Conversion Toolkit is ready!")
        sleep(1)
        self.start()
    ...
    def start(self):
        ...
        match choice:
            ...
            case 12:
                self.hex_to_octal()
            case _:
                print("❗ That isn’t a valid option. Restart the tool.")
    ...
...
class Searching:
    ...
    def menu(self):
        ...
        try:
            ...
            print("❗ That’s not a number. Choose between 1 and 6.")
            return self.menu()
        ...
        if choice == 1:
            ...
            print("❗ Ooops! Pick a number from 1 to 6.")
            self.menu()
# endregion
...
def main():
    ...
    while True:
        clear_screen()
        print("🌟 Welcome to Vic Luzano's Algorithm Adventure 🌟")
